...
const ManageOrders = () => {
  ...
  const onChangeOrderFilterType = (e) => {
    ...
    if (value === '1') {
      ...
      filteredOrders = orders.filter(
        (o) => o.azst_orders_status === 1 && o.azst_orders_confirm_status === 0
      );
    } else if (value === '2') {
      // rejected
      filteredOrders = orders.filter(
        (o) => o.azst_orders_status === 1 && o.azst_orders_confirm_status === 2
      );
    } else if (value === '3') {
      // cancelled
      filteredOrders = orders.filter(
        (o) => o.azst_orders_status === 0 && o.azst_orders_confirm_status === 0
      );
    } else if (value === '4') {
      //deliverd
      filteredOrders = orders.filter(
        (o) =>
          o.azst_orders_status === 1 &&
          o.azst_orders_confirm_status === 1 &&
          o.azst_orders_delivery_status === 2
      );
    } else {
            ...
            <div
              ...
              <div className=''>
                ...
                <select
                  ...
                  value={selectedType}
                  onChange={onChangeOrderFilterType}>
                  <option value='0'>All Orders</option>
                  <option value='1'>Placed Orders</option>
