...
const OtpRegistration = () => {
    ...
    const onSubmitNumber = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(url, { mailOrMobile: inputValue.enterNumber });
        ...
        return (
            <form onSubmit={onSubmitNumber}>
                <div>
                    ...
                    <input className="form-control" placeholder="Mail/Phone" type="text" value={inputValue.enterNumber} onChange={handleInputEvent} id="enterNumber" />
        ...
        return (
            <form onSubmit={onSubmitOtp}>
                <div>
                    ...
                    <input className="form-control" type="text" value={inputValue.enterOtp} onChange={handleInputEvent} id="enterOtp" />
